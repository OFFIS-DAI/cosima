...
from cosima_core.simulators.core.comm_simulator import CommSimulator, CommModel
from cosima_core.simulators.core.omnetpp_connection import OmnetppConnection
from cosima_core.util.util_functions import get_agent_names
...
def test_check_msgs():
    ...
    msg_2 = msg_group.msg.add()
    msg_2.type = CosimaMsgGroup.CosimaMsg.MsgType.RECONNECT
    msg_2.msgId = 'Test_Message_0'
    msg_2.simTime = 2

    # simTime is further than last message time
    msgs = [msg, msg_2]
